...
var RetData = {
    ...
    "lib_name": "string",
    "version": "string",
    "overflow": ["string", "number", "shell", "computer", "file"],
    // Metaxploit,
    "load": ["metalib", "null"],
    "net_use": ["metalib", "null"],
    "rshell_client": ["number"],
    "rshell_server": ["list"],
    "scan_address": ["string"],
    "scan": ["list"],
    "sniffer": ["string"],
    ...
    "delete_group": "number",
    "groups": "string",
    "close_program": "number",
    "wifi_networks": "list",
    "connect_wifi": "number",
    "connect_ethernet": "number",
    "network_gateway": "string",
    "active_net_card": "string",
    // General,
    "typeof": "string",
    "get_router": ["router", "null"],
    "get_switch": ["router", "null"],
    "nslookup": "string",
    "print": "number",
    "clear_screen": "null",
    "active_user": "string",
    "home_dir": "string",
    "get_shell": ["shell", "null"],
    "user_input": "string",
    "include_lib": ["crypto", "metaxploit"],
    "import_code": "null",
    "exit": "null",
...
var HoverData = {
    ...
    "touch": "Computer.touch(string path, string name) : Int or String\n\nCreate an empty text file.\n\nReturns 1 on success, or a string (containing an error) on failure",
